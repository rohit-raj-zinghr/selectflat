        ...
        SELECT ShiftID,
            (
                SELECT 
                    ...
                    -- pretime yaha pe
                    (SELECT TOP 1 RuleItemValue 
                     FROM TNA.Vw_RuleConfigData 
                     WHERE RuleEndDate IS NULL 
                     AND ShiftID = s.ShiftID 
                     AND Org6 = '23215' 
                     AND RuleRelatedTo = 'Shift Properties' 
                     AND RuleConfigAttrItemName = 'Pre Time Minutes') AS PreTime,
                    ...
                    (SELECT TOP 1 RuleItemValue 
                     ...
                     AND Org6 = '23215' 
                     AND RuleRelatedTo = 'Shift Properties' 
                     AND RuleConfigAttrItemName = 'Post Time') AS PostTime,
